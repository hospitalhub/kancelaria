...
public class AdresEditorWindow extends Window {
  ...
  private void initEditor() {
    ...
    for (String fieldName : Adres.COLUMN_NAMES) {
      ...
      if (fieldName.equals(Adres.ID) || fieldName.equals(Adres.TEL1) || fieldName.equals(Adres.TEL2)
          || fieldName.equals(Adres.FAX) || fieldName.equals(Adres.MAIL)) {
        continue;
      }
