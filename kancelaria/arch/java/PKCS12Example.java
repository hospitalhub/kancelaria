...
/**
 * Example of how to set up a certificiate chain and a PKCS 12 store for a private individual -
...
public class PKCS12Example {
  private static final String SHA1_WITH_RSA_ENCRYPTION = "SHA1WithRSAEncryption";

  private static final String ANDRZEJ_MARCINKOWSKI_GMAIL_COM = "andrzej.marcinkowski@gmail.com";

  private static final String MAIL = "sekretariat@szpital.kalisz.pl";

  private static final String PL = "PL";

  private static final String WOJEWÓDZKI_SZPITAL_ZESPOLONY_W_KALISZU =
      "Wojewódzki Szpital Zespolony w Kaliszu";

  private static final String WSZ_CERTYFIKAT = "WSZ Certyfikat";
  ...
  public static Certificate createMasterCert(PublicKey pubKey, PrivateKey privKey) throws Exception {
    ...
    // signers name
    //
    String issuer = "C=PL, O=WSZ, OU=Wojewódzki Szpital Zespolony Certyfikat";

    //
    // subjects name - the same as we are self signed.
    //
    String subject = "C=PL, O=WSZ, OU=WSZ";
    ...
    v1CertGen.setSignatureAlgorithm(SHA1_WITH_RSA_ENCRYPTION);
  ...
  public static Certificate createIntermediateCert(PublicKey pubKey, PrivateKey caPrivKey,
    ...
    attrs.put(X509Principal.C, PL);
    attrs.put(X509Principal.O, WOJEWÓDZKI_SZPITAL_ZESPOLONY_W_KALISZU);
    attrs.put(X509Principal.OU, WSZ_CERTYFIKAT);
    attrs.put(X509Principal.EmailAddress, MAIL);
    ...
    v3CertGen.setSignatureAlgorithm(SHA1_WITH_RSA_ENCRYPTION);
    ...
    //
    bagAttr.setBagAttribute(PKCSObjectIdentifiers.pkcs_9_at_friendlyName, new DERBMPString(
        WOJEWÓDZKI_SZPITAL_ZESPOLONY_W_KALISZU));
  ...
  public static Certificate createCert(PublicKey pubKey, PrivateKey caPrivKey, PublicKey caPubKey)
    ...
    sAttrs.put(X509Principal.C, PL);
    sAttrs.put(X509Principal.O, WOJEWÓDZKI_SZPITAL_ZESPOLONY_W_KALISZU);
    sAttrs.put(X509Principal.OU, WSZ_CERTYFIKAT);
    sAttrs.put(X509Principal.EmailAddress, MAIL);
    ...
    attrs.put(X509Principal.C, PL);
    attrs.put(X509Principal.O, WOJEWÓDZKI_SZPITAL_ZESPOLONY_W_KALISZU);
    attrs.put(X509Principal.L, "Kalisz");
    attrs.put(X509Principal.CN, "Andrzej Marcinkowski");
    attrs.put(X509Principal.EmailAddress, ANDRZEJ_MARCINKOWSKI_GMAIL_COM);
  ...
  public static void main(String[] args) throws Exception {
    ...
    RSAPrivateCrtKeySpec privKeySpec =
        new RSAPrivateCrtKeySpec(
            ...
            new BigInteger(
                ...
                16), new BigInteger(
                "c0a0758cdf14256f78d4708c86becdead1b50ad4ad6c5c703e2168fbf37884cb", 16),
    ...
    //
    store.setKeyEntry("Siaty klucz", privKey, null, chain);

    File f = new File("id.p12");
