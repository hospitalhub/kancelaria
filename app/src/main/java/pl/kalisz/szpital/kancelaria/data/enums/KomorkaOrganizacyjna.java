...
public enum KomorkaOrganizacyjna {
  ...
  /** The no. */
  NO("NO", "Dział Organizacyjny"),
  /** The nok. */
  NOK("NOK", "Kancelaria"),
  /** The nos. */
  NOS("NOS", "Sekretariat"), //
  /** The N o2. */
  NO2("LSD2", "(NO2 przed 24.02.2016) Dokumentacja Medyczna"), //
  /** The N o3. */
  NO3("LSD1", "(NO3 przed 24.02.2016) Statystyka medyczna"), //
  /** The N o4. */
  NO4("LSD3", "(NO4 przed 24.02.2016) Archiwum"), //
  /** The lsd. */
  LSD("LSD", "Dział Statystyki i Dokumentacji Medycznej"), //
  /** The N o2. */
  LSD2("LSD2", "Dokumentacja Medyczna"), //
  /** The N o3. */
  LSD1("LSD1", "Statystyka medyczna"), //
  /** The N o4. */
  LSD3("LSD3", "Archiwum"), //
  /** The np. */
  ...
  /** The nabi. */
  NABI("NABI", "Administrator Bezepieczeństwa Informacji"), //
  /** The nasi. */
  NASI("NASI", "Administrator Systemów Informatycznych"), //
  /** The tr. */
  ...
  /** The ek. */
  EK("EK", "Dział Kontraktowania i Rozliczania Świadczeń Zdrowotnych"), //
  /** The el. */
  ...
  LK("LK", "Kierownicy"), //
  /** The lkwi. */
  LKWI("LKWI", "Oddział Chorób Wewnętrznych I"), //
  /** The lkg. */
  LKG("LKG", "Oddział Gastroenterologii"), //
  /** The lkwii. */
  ...
  LKA("LKA", "Apteka"), //
  /** The lkok. */
  LKOK("LKOK", "Oddział Onkologii Klinicznej"), //
  /** The lpeeg. */
  ...
  /** lozi. */
  LOZI("LOZI", "Onkologiczny Zesp\363\u0142 Interdyscyplinarny wraz z Koordynatorem"), //
  /** The lpsa. */
  ...
  /** The lpcr. */
  LPSCHE("LPSCHE", "Poradnia Chemioterapii"), //
  /** The lpcr. */
  LPCR("LPCR", "Centralna Rejestracja"), //
  /** The po. */
  PO("PO", "Oddziałowe"), //
  /** The powi. */
  POWI("POWI", "Oddziałowa Oddziału Chorób Wewnętrznych I"),
  /** The pog. */
  POG("POG", "Oddziałowa Oddziału Gastroenterologicznego"),
  /** The powii. */
  ...
  /** The pook. */
  POOK("POOK", "Oddział Onkologii Klinicznej"),
  /** The popg. */
  ...
  /** The stp. */
  SLD("SLD", "Starszy Lekarz Dyżurny"), //
  /** The stp. */
  ...
  /** The inpr. */
  KDA("LKsA", "(KDA do 24.02.2016) Koordynator ds Akredytacji"),
  /** The lksa. */
  LKSA("LKsA", "Koordynator ds. Akredytacji"),
  /** The klpo. */
  KLPO("LKsLO", "(KLPO dp 24.02.2016) Koordynator ds Lececznia Pacjentów Onkologicznych"),
  /** The klslo. */
  KLSLO("LKsLO", "Koordynator ds. Leczenia Pacjentów Onkologicznych"),
  /** The klsokk. */
  LKSOKK("LKsOKK", "Koordynator ds. Okołooperacyjnej Karty Kontrolnej"),
  /** The lior. */
  LIOR("LIOR", "Inspektor Ochrony Radiologicznej"),
  /** The inpr. */
  PKZ("PKZ", "Przewodniczący Komitetu ds Zakażeń"), //
  /** The inpr. */
  PKOM("PKOM", "Przewodniczący Komitetu ..."), //
  /** The inpr. */
  PKPRZ("PKZ", "Przewodniczący Komisji Przyśpieszeń"), //
  /** The inpr. */
