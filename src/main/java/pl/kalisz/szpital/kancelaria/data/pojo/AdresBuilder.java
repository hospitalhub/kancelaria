...
public class AdresBuilder {
   ...
   * Sets the id new.
   * 
   * @param idNew the new id new
   */
  public final void setIdNew(final Integer idNew) {
    this.idNew = idNew;
  }
   ...
   */
  public AdresBuilder(final Integer idNew) {
    this.idNew = idNew;
  }
   ...
   * Adres.
   * 
   * @param ulica the ulica
   * @param kod the kod
   * @param miasto the miasto
   * @return the adres builder
   */
  public final AdresBuilder adres(final String ulica, final String kod, final String miasto) {
    this.ulica = ulica;
    this.kod = kod;
    this.miasto = miasto;
    return this;
   ...
   * @return the adres builder
   */
  public final AdresBuilder kontaktowe(final String tel1, final String tel2, final String fax,
      final String mail) {
    this.tel1 = tel1;
    this.tel2 = tel2;
    this.fax = fax;
