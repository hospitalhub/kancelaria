...
public enum TypWiadomosci {
  ...
  PRZYCHODZĄCE_ZEWNĘTRZNE("Przychodzące zewnętrzne", "icon-zewn", false, false, true, FontAwesome.ARROW_CIRCLE_DOWN),

  /** The PRZYCHOD zą c e_ wew nę trzne. */
  PRZYCHODZĄCE_WEWNĘTRZNE("Przychodzące wewnętrzne", "icon-wewn", false, true, true, FontAwesome.DOT_CIRCLE_O),

  /** The WYCHOD zą c e_ polecone. */
  WYCHODZĄCE_POLECONE("Wychodzące polecone", "icon-polecony", true, false, false, FontAwesome.ENVELOPE_O),

  /** The WYCHOD zą ce. */
  WYCHODZĄCE("Wychodzące zwykłe", "icon-wychodzace", false, false, false, FontAwesome.ENVELOPE),

  /** The archiwum. */
  ARCHIWUM("Archiwum", "icon-wychodzace", true, FontAwesome.ARCHIVE);
   ...
   */
  private TypWiadomosci(final String tytul, final String styl, final boolean archiwalny, FontAwesome icon) {
    this.nazwa = tytul;
    this.styl = styl;
  ...
  TypWiadomosci(final String tytul, final String styl, final boolean polecony,
      final boolean wewnetrzny, final boolean przychodzacy, FontAwesome icon) {
    this.nazwa = tytul;
    this.styl = styl;
