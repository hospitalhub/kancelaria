...
public class TransactionBuilder {
   ...
   * @param id the id
   */
  public TransactionBuilder(final Integer id) {
    this.id = id;
  }
   ...
   * @return the transaction builder
   */
  public final TransactionBuilder id(final Integer id) {
    this.id = id;
    return this;
  }
   ...
   * @return the transaction builder
   */
  public final TransactionBuilder adres(final Address adres) {
    this.adres = adres;
    return this;
  }
